 ...
 * Separating-Axis-Theorem solver. Ported from VEL ({@code net.vibey.vel.internal.assemblies
 * .collision.OrientedBoundingBox3d}), itself a near-verbatim copy of sable's
 * {@code dev.ryanhcode.sable.api.math.OrientedBoundingBox3d}.
 *
