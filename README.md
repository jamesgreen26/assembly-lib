...
A standalone NeoForge library mod (Minecraft 1.21.1) providing **block-entity-hosted contraptions**:
...
Extracted from [Zero Point Systems](../ZeroPointSystems). The contraption core does not depend on
Create (`com.simibubi`); it uses Flywheel for rendering and Catnip's wrapped levels for the
server-side simulation.

## What's inside
- `com.assemblylib.contraption` — contraption model, simulation levels, transforms, collision
...
- `com.assemblylib.networking` — contraption place/break/use packets
